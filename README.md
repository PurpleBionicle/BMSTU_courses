...
<h3> Сертификация СЗИ </h3>

| Ссылка               |                         https://github.com/PurpleBionicle/fuzzing_labs                           |
|----------------------|:-------------------------------------------------------------------------------------------------------:|
| фаззинг (afl++) | сбор покрытия (lcov) | 
| контрольное суммирование дистрибутива | обработка SAST-срабатываний | 

<h3> Системы электронной валюты </h3>

| Ссылка               |                         https://github.com/PurpleBionicle/electronic_currency_systems                        |
|----------------------|:-------------------------------------------------------------------------------------------------------:|
| Решение задач ethernaut |  
